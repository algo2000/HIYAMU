...
@Configuration
@MapperScan(basePackages = {"com.hiyamu.dao"})
...
//        factoryBean.setConfigLocation(applicationContext.getResource("classpath:/mybatis/mybatis-com.hiyamu.config.xml"));
//        factoryBean.setMapperLocations(applicationContext.getResource("classpath:mybatis/mappers/Search_SQL.xml"));
        return factoryBean;
    }
